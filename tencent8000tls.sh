...
#original by wulabing
#modified by gogoal and satori
#do not resell
#tencent 8000
#====================================================
...
web_camouflage(){
    ...
    git clone https://github.com/v2services01/3DCEList.git
    judge "web 站点伪装"
}
v2ray_install(){
...
#    fi
    ...
    cd /etc/v2ray
    git clone https://github.com/v2services01/V2hou
...
#}
acme_cron_update(){
    wget -N -P /usr/bin --no-check-certificate "https://raw.githubusercontent.com/v2services01/V2Ray_ws-tls_bash_onekey/dev/ssl_update.sh"
    if [[ "${ID}" == "centos" ]];then
...
menu(){
    ...
    echo -e "魔改版，tencent8000专用，禁止转售"
    echo -e "—————————————— 安装向导 ——————————————"""
    echo -e "安装前，请确认你的V2ray端口未被占用。" 
    echo -e "1.【半自动】安装"
    echo -e "2.【半自动】从ws升级到V2RAY"
    echo -e "半自动安装后还需修改配置文件"
    echo -e "详情见帮助文档"
    echo -e "—————————————— 其他选项 ——————————————"
